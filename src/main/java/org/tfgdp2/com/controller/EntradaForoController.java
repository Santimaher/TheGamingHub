...
public class EntradaForoController {
	...
	public String leerResp(@RequestParam("idForo") Long id, @RequestParam("idEntrada") Long idEntrada, ModelMap m,
			HttpSession s) {
	...
	@GetMapping("r")
	public String leer(HttpSession s, @RequestParam("idForo") Long id, ModelMap m,
		...
		case "Comentario": {
			m.put("entradas",
					repoEntrada.findByPerteneceIdAndMensajePadreIdAndComentarioIgnoreCaseContainingOrderByRankingDesc(
							id, null, filtro));
		}
			break;
		case "normal": {
	...
	public String responder(@RequestParam("idForo") Long idForo, ModelMap m, @RequestParam("idEntrada") Long idEntrada,
	...
	public void responderPostSI(@RequestParam("titulo") String titulo, @RequestParam("idForo") Long idForo,
			@RequestParam("idEntrada") Long idEntrada, @RequestParam("comentario") String comentario, ModelMap m,
	...
	public void responderPostCI(@RequestParam("img") MultipartFile img, @RequestParam("titulo") String titulo,
			@RequestParam("idForo") Long idForo, @RequestParam("idEntrada") Long idEntrada, ModelMap m, HttpSession s)
	...
	@PostMapping("cSi")
	public void cPostSi(@RequestParam("titulo") String titulo, @RequestParam("ide") Long id,
			@RequestParam("comentario") String comentario, ModelMap m, HttpSession s)
			throws DangerException, InfoException {
		try {
			H.isRolOK("auth", s);
			EntradaForo entrada = new EntradaForo();
	...
	@PostMapping("cCi")
	public void cPostCi(@RequestParam("img") MultipartFile img, @RequestParam("titulo") String titulo,
			@RequestParam("ide") Long id, ModelMap m, HttpSession s) throws DangerException, InfoException {
		try {
			H.isRolOK("auth", s);
			EntradaForo entrada = new EntradaForo();
			entrada.setTitulo(titulo);
	...
	@GetMapping("like")
	public void darLike(ModelMap m, @RequestParam("id") Long idEntrada, @RequestParam("idForo") Long id, HttpSession s)
			throws DangerException, InfoException {
		H.isRolOK("auth", s);
		Usuario u = (Usuario) s.getAttribute("usuario");
		Long idUsuario = u.getId();
	...
	@GetMapping("dislike")
	public void quitarLike(ModelMap m, @RequestParam("id") Long idEntrada, @RequestParam("idForo") Long id,
			HttpSession s) throws DangerException, InfoException {
		H.isRolOK("auth", s);
		Usuario u = (Usuario) s.getAttribute("usuario");
		Long idUsuario = u.getId();
	...
	@GetMapping("likeR")
	public void darLikeRespuesta(ModelMap m, @RequestParam("id") Long idEntrada, @RequestParam("idForo") Long id,
			HttpSession s) throws DangerException, InfoException {
		H.isRolOK("auth", s);
		Usuario u = (Usuario) s.getAttribute("usuario");
		Long idUsuario = u.getId();
	...
	@GetMapping("dislikeR")
	public void quitarLikeRespuesta(ModelMap m, @RequestParam("id") Long idEntrada, @RequestParam("idForo") Long id,
			HttpSession s) throws DangerException, InfoException {
		H.isRolOK("auth", s);
		Usuario u = (Usuario) s.getAttribute("usuario");
		Long idUsuario = u.getId();
	...
	@PostMapping("u")
	public void uPost(@RequestParam("comentario") String comentario, @RequestParam("idEntrada") Long idEntrada,
			HttpSession s, ModelMap m) throws InfoException, DangerException {
